...
AgachaCharacter::AgachaCharacter()
{
...
void AgachaCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AgachaCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AgachaCharacter::Move);
...
void AgachaCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AgachaCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
